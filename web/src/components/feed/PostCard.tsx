...
import { User, MessageCircle, Heart, Share2, Flag } from 'lucide-react';
  ...
  return (
    <>
      ...
      <Card className="border-slate-800 bg-slate-900/50 mb-4">
        <CardHeader className="flex-row gap-3 space-y-0 p-4 justify-between items-start">
          ...
          <Button variant="ghost" size="icon" className="h-8 w-8 text-slate-600 hover:text-red-400" onClick={() => setShowReport(true)}>
